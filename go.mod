...
require (
	...
	github.com/attestantio/go-relay-client v0.1.0
...
require (
	...
	github.com/attestantio/go-builder-client v0.1.6 // indirect
	github.com/attestantio/go-eth2-client v0.13.6 // indirect
